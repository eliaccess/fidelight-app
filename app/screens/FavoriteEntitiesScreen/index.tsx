...
import FavoriteEntitiesScreenLoader from './Loader';
import style from './style';

const FavoriteEntitiesScreen: React.FC<FavoriteEntitiesScreenProps> = (
  props,
) => {
  ...
  return (
    ...
    >
      {!showContent ? (
        <FavoriteEntitiesScreenLoader numberOfItems={4} />
      ) : (
