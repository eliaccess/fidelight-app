  ...
  <View style={style.infoContainer}>
    ...
    <View>
      <View style={style.contactInfoItem}>
        ...
        <Text style={style.contactInfoItemLabel}>{props.data.streetName}</Text>
      </View>
      <View style={style.contactInfoItem}>
      ...
      <View style={style.contactInfoItem}>
        ...
        <Text style={style.contactInfoItemLabel}>{props.data.websiteUrl}</Text>
      </View>
    </View>
  </View>
);
