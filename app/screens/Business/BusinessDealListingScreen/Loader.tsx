/**
 *
 * BusinessDealListingScreenLoader
 *
 */
...
interface BusinessDealListingScreenLoaderProps {
  numberOfItems: number;
}

const BusinessDealListingScreenLoader: React.FC<BusinessDealListingScreenLoaderProps> =
  ({ numberOfItems }) => {
...
export default BusinessDealListingScreenLoader;
